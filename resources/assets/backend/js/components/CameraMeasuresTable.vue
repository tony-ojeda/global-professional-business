...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            Echo.channel('camera_measures_trigger').listen('RecordTrigger', (e) => {
                this.datatable.ajax.reload();
            })
            ...
            fillTable: function() {
                ...
                this.datatable = $('#' + this.table_container).DataTable( {
                    ...
                    columns: [
                        ...
                        { data: "name", title: "Trabajador", sortable: false },
                        { data: "rfid", title: "RFID", sortable: false, width: 100 },
                        { data: "temperature", title: "Cº", sortable: false, width: 100 },
                        { data: "created", title: "Fecha y hora", sortable: false, width: 150 },
                        {
                            data: null,
                            title: 'Tipo',
                            width: 100,
                            ...
                            render: function ( data, type, row ) {
                                switch (row.type) {
                                    case 0:
                                        return '<div class="badge badge-success">Salida</div>'
                                        break;
                                    case 1:
                                        return '<div class="badge badge-primary">Entrada</div>'
                                        break;
                                
                                    default:
                                        return '<div class="badge badge-secondary">Sin estado</div>'
                                        break;
                                }
                            } 
                        }
