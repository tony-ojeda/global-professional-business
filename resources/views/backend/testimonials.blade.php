        ...
        <div class="col-12 col-md-6">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <testimonial-form
                            :url="'{{ route('admin.testimonials.controller') }}'"
                        >
                        </testimonial-form>
                    </div>
                </div>
        ...
        <div class="col-12 col-md-6">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <testimonial-table
                            :url-list="'{{ route('admin.testimonials.list') }}'"
                            :url-detail="'{{ route('admin.testimonials.find') }}'"
                            :url-delete="'{{ route('admin.testimonials.delete') }}'"
                        >
                        </testimonial-table>
                    </div>
                </div>
